...
/// <summary>
/// Service for Job Level Approved operations
/// </summary>
public class JobLevelApprovedService : IJobLevelApprovedService
{
    private readonly IJobLevelApprovedRepository _repository;
    ...
    public JobLevelApprovedService(IJobLevelApprovedRepository repository)
    {
    ...
    public async Task<JobLevelApprovedResponse> GetJobLevelApprovedAsync(JobLevelApprovedRequest request)
    {
        ...
        return await _repository.GetJobLevelApprovedAsync(request);
    }

    private static void ValidateRequest(JobLevelApprovedRequest request)
    {
