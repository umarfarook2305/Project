...
/// <summary>
/// Service for Pending Status Distribution operations
/// </summary>
public class PendingStatusDistributionService : IPendingStatusDistributionService
{
    private readonly IPendingStatusDistributionRepository _repository;
    ...
    public PendingStatusDistributionService(IPendingStatusDistributionRepository repository)
    {
    ...
    public async Task<PendingStatusDistributionResponse> GetPendingStatusDistributionAsync(PendingStatusDistributionRequest request)
    {
        ...
        return await _repository.GetPendingStatusDistributionAsync(request);
    }

    private static void ValidateRequest(PendingStatusDistributionRequest request)
    {
