...
/// <summary>
/// Service for Approved Role Distribution operations
/// </summary>
public class ApprovedRoleDistributionService : IApprovedRoleDistributionService
{
    private readonly IApprovedRoleDistributionRepository _repository;
    ...
    private static readonly List<string> ValidViewTypes = new() { "MyView", "MyTeam", "My Team", "MyOrg", "All" };

    public ApprovedRoleDistributionService(IApprovedRoleDistributionRepository repository)
    {
    ...
    public async Task<ApprovedRoleDistributionResponse> GetApprovedRoleDistributionAsync(ApprovedRoleDistributionRequest request)
    {
        ...
        return await _repository.GetApprovedRoleDistributionAsync(request);
    }

    private static void ValidateRequest(ApprovedRoleDistributionRequest request)
    {
