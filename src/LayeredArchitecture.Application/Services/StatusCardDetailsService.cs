...
/// <summary>
/// Service for Status Card Details operations
/// </summary>
public class StatusCardDetailsService : IStatusCardDetailsService
{
    private readonly IStatusCardDetailsRepository _repository;
    ...
    public StatusCardDetailsService(IStatusCardDetailsRepository repository)
    {
    ...
    public async Task<StatusCardDetailsResponse> GetStatusCardDetailsAsync(StatusCardDetailsRequest request)
    {
        ...
        return await _repository.GetStatusCardDetailsAsync(request);
    }

    private static void ValidateRequest(StatusCardDetailsRequest request)
    {
        ...
        // If DURATION filter type, duration is required
