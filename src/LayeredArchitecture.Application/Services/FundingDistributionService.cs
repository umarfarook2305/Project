...
/// <summary>
/// Service for Funding Distribution operations
/// </summary>
public class FundingDistributionService : IFundingDistributionService
{
    private readonly IFundingDistributionRepository _repository;
    ...
    public FundingDistributionService(IFundingDistributionRepository repository)
    {
    ...
    public async Task<FundingDistributionResponse> GetFundingDistributionAsync(FundingDistributionRequest request)
    {
        ...
        return await _repository.GetFundingDistributionAsync(request);
    }

    private static void ValidateRequest(FundingDistributionRequest request)
    {
